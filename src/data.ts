...
export const translations = {
  en: {
    ...
    employees: {
      ...
      items: [
              { name: "Yigitali Abdullaev",     role: "director",      photo: "/static/assets/employees/01.jpg" },
              { name: "Botir",                  role: "teacher",       photo: "/static/assets/employees/02.jpg" },
              { name: "Jahongir Pardayev",      role: "teacher",       photo: "/static/assets/employees/03.jpg" },
              { name: "Sarvar",                 role: "teacher",       photo: "/static/assets/employees/04.jpg" },
              { name: "Sadbarg Raxmonova",      role: "manager",       photo: "/static/assets/employees/05.jpg" },
              { name: "Iskandar Tojiyev",       role: "manager",       photo: "/static/assets/employees/06.jpg" },
              { name: "Maqsuda Karimovna",      role: "manager",       photo: "/static/assets/employees/07.jpg" },
              { name: "Abdulaziz Jamoliddinov", role: "teacher",       photo: "/static/assets/employees/08.jpg" },
              { name: "Elchin Tojimurodov",     role: "teacher",       photo: "/static/assets/employees/09.jpg" },
              { name: "Dildora",                role: "teacher",       photo: "/static/assets/employees/10.jpg" },
              { name: "Bekhruz Mansurov",       role: "it_teacher",    photo: "/static/assets/employees/11.jpg" },
              { name: "Odilbek Safarov",        role: "it_specialist", photo: "/static/assets/employees/12.jpg" },
              { name: "Jumayev Toshmirza",      role: "teacher",       photo: "/static/assets/employees/13.jpg" },
              { name: "Rasulbek Saidoov",       role: "manager",       photo: "/static/assets/employees/14.jpg" }
            ]
    },
    services: {
      label: "Services",
  ...
  uz: {
    ...
    employees: {
      ...
      items: [
                    { name: "Yigitali Abdullaev",     role: "direktor",             photo: "/static/assets/employees/01.jpg" },
                    { name: "Botir",                  role: "o'qituvchi",           photo: "/static/assets/employees/02.jpg" },
                    { name: "Jahongir Pardayev",      role: "o'qituvchi",           photo: "/static/assets/employees/03.jpg" },
                    { name: "Sarvar",                 role: "o'qituvchi",           photo: "/static/assets/employees/04.jpg" },
                    { name: "Sadbarg Raxmonova",      role: "menejer",              photo: "/static/assets/employees/05.jpg" },
                    { name: "Iskandar Tojiyev",       role: "menejer",              photo: "/static/assets/employees/06.jpg" },
                    { name: "Maqsuda Karimovna",      role: "menejer",              photo: "/static/assets/employees/07.jpg" },
                    { name: "Abdulaziz Jamoliddinov", role: "o'qituvchi",           photo: "/static/assets/employees/08.jpg" },
                    { name: "Elchin Tojimurodov",     role: "o'qituvchi",           photo: "/static/assets/employees/09.jpg" },
                    { name: "Dildora",                role: "o'qituvchi",           photo: "/static/assets/employees/10.jpg" },
                    { name: "Bekhruz Mansurov",       role: "IT o'qituvchisi",      photo: "/static/assets/employees/11.jpg" },
                    { name: "Odilbek Safarov",        role: "IT mutaxassisi",       photo: "/static/assets/employees/12.jpg" },
                    { name: "Jumayev Toshmirza",      role: "o'qituvchi",           photo: "/static/assets/employees/13.jpg" },
                    { name: "Rasulbek Saidoov",       role: "menejer",              photo: "/static/assets/employees/14.jpg" }
                  ]
    },
    services: {
      label: "Xizmatlar",
